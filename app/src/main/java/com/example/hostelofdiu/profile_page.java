...
public class profile_page extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView name,phone, student_id_txtvw,edit_name_txtvw;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        student_id_txtvw = findViewById(R.id.profile_student_id);
                    ...
                    .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                        ...
                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                            for (QueryDocumentSnapshot document : queryDocumentSnapshots) {
                                ...
                                name.setText(document.getString("name"));
                                phone.setText("Phone : "+document.getString("phone"));
                                student_id_txtvw.setText("ID : "+document.getString("student_id"));
                            }
                        }
                    });
        }
