...
public class profile_view extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView profile_name_txtvw, phone_txtvw, student_id_txtvw;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        student_id_txtvw = findViewById(R.id.profile_view_student_id_txtvw);
                ...
                .get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        if (documentSnapshot.exists()) {
                            ...
                            student_id_txtvw.setText("ID : "+documentSnapshot.getString("student_id"));
