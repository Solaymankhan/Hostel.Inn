...
public class create_account_page extends AppCompatActivity implements View.OnClickListener {
    ...
    TextInputLayout full_name, user_id, user_phone, password1, password2;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_id = findViewById(R.id.createaccount_stdnt_id_edtxt_id);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.createaccount_back_bnt_id) {
            ...
            if (!validate_name() | !validate_id() | !validate_phone() | !validate_password_1() | !validate_password_2()) {
                return;
            }
            ...
            String _user_id = user_id.getEditText().getText().toString().trim();
    ...
    private boolean validate_id() {
        String val = user_id.getEditText().getText().toString().trim();
        if (val.isEmpty()) {
            user_id.setError("Field can not be empty");
            return false;
        } else if (val.length() < 11) {
            user_id.setError("Must be more then 10 character");
            return false;
        } else {
